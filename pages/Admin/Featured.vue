<template>
  <div style="overflow: auto; height: 98.5vh">
    <div class="tabs">
      <div :class="tab == 'tab-1' && 'active-tab'" @click="ChangeTab('tab-1')">
      ...
      <div :class="tab == 'tab-4' && 'active-tab'" @click="ChangeTab('tab-4')">
