<template>
  <div>
    ...
    <section class="service-area service-categories pt-100">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="service-content">
              ...
              <p>
                Some advantage from but who has any right tfind fault with a man
                chooses
              </p>
            </div>
          </div>
...
.top-header-area .col-lg-9 .row {
  border-bottom: 1px solid #5d6aed;
  border-right: 1px solid #5d6aed;
}
...
.top-header-area .container .row .col-lg-3.border {
  border-bottom: 1px solid #5d6aed !important;
  border-left: 1px solid #5d6aed !important;
  padding-right: 0;
  border-right: 1px solid transparent !important;
  border-top: 1px solid transparent !important;
}
.top-header-social-links ul li:last-child a {
  border-right: 1px solid #5d6aed;
}
...
.hero-bg-2 {
  background: url("~/assets/images/hero/2.jpg");
  background-color: #ddd;
}
.hero-bg-3 {
...
----------------------------------------*/
.vdeo-bg {
  background: url("~/assets//images/watch-bg.jpg");
  background-color: #ddd;
}
...
.video-content {
  ...
  width: 33%;
  background: #21249c;
  background: -moz-linear-gradient(left, #21249c 0%, #487bef 100%);
  background: -webkit-linear-gradient(left, #21249c 0%, #487bef 100%);
  background: linear-gradient(to right, #21249c 0%, #487bef 100%);
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#21249c', endColorstr='#487bef',GradientType=1 );
  z-index: 2;
  padding: 100px 50px;
  right: 130px;
  bottom: -130px;
...
----------------------------------------*/
.breadcrumb-bg-1 {
  background: url("~/assets/images/breadcrumb-1.jpg");
  background-color: #ddd;
}
.breadcrumb-bg {
  position: relative;
