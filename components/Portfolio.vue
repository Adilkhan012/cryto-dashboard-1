<template>
    ...
    <section class="portfolio-area pt-140 pb-140" id="portfolio">
      <div class="container">
        <div class="row pb-80">
          <div class="col-lg-5">
          ...
          <div class="col-lg-7 text-right">
            <div class="portfolio-btn-area">
              <a href="#" class="btn portfolio-btn"
                >View more <i class="fa fa-arrow-right"></i
              ></a>
              <a href="#" class="portfolio-btn-2"
                >Let’s Talk <i class="fa fa-arrow-right"></i
              ></a>
            </div>
          </div>
        </div>
            ...
            <div class="single-portfolio-item">
              ...
              <div class="portfolio-overlay-content">
                ...
                <a
                  ...
                  class="portfolio-icon img-popup"
